...
import { getProductById, updateProductWithImage, getAdminProductImageUrl } from '@/api/admin'
...
export default function EditProduct() {
    ...
    const loadProduct = async () => {
        try {
            ...
            if (productData.originalImageName || productData.imageData) {
                setImagePreview(getAdminProductImageUrl(productData))
            }
        } catch (err: any) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (formData.categoryId.trim()) {
                submitData.append('categoryId', formData.categoryId.trim())
            }
            ...
            await updateProductWithImage(productId, submitData)
        ...
        return (
            <div className="min-h-screen bg-gray-100 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link href="/admin/products" className="mt-4 text-blue-600 hover:text-blue-800">
                        ← Back to Products
                    </Link>
                </div>
            </div>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-2">
                                        {imageFile ? 'New image selected. ' : ''}Upload a new image to replace the current one. Supported formats: JPG, PNG, GIF. Max size: 5MB
                                    </p>
                                </div>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <dl className="text-sm text-gray-600 space-y-1">
                                        <div className="flex justify-between">
                                            <dt>Product ID:</dt>
                                            <dd className="font-mono">{product.productId}</dd>
                                        </div>
                                        {product.sku && (
                                            <div className="flex justify-between">
                                                <dt>Current SKU:</dt>
